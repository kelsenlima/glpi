...
'
SetupOptions = "/S /acceptlicense /no-start-menu /runnow /server='http://172.24.0.45/plugins/fusioninventory/' /add-firewall-exception /installtasks=Full /execmode=Service /httpd-trust='127.0.0.1,172.24.0.0/24'"
